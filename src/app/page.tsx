...
export default function AffiliateLinksPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-orange-50">
      {/* Header Fixo */}
      <header className="fixed top-0 w-full bg-white/90 backdrop-blur-sm shadow-md z-50">
      ...
      >
        <div className="text-center text-white px-4 max-w-4xl mx-auto">
          ...
          <EditableText
            ...
            type="title"
            className="text-4xl md:text-6xl font-bold mb-6 block text-yellow-300"
            onSave={updateSiteContent}
            isAdminMode={isAuthenticated}
          />
          <EditableText
          ...
          <button 
            onClick={() => scrollToSection('ofertas')}
            className="bg-white text-blue-600 font-bold py-3 px-8 rounded-full text-lg hover:bg-blue-50 transition-colors"
          >
            Aproveitar Agora
          </button>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 resize-none"
